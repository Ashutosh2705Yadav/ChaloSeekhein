...
<nav class="bg-white shadow mb-6">
  ...
  <h2 class="text-2xl font-bold mb-4">Upload Learning Materials</h2>
  ...
  <h3 class="text-xl font-semibold mb-2">Available Materials</h3>
  <ul class="list-disc pl-6">
    <?php
      $files = scandir("uploads/");
      foreach($files as $file) {
        if ($file != "." && $file != "..") {
          echo "<li><a href='uploads/$file' class='text-blue-500' download>$file</a></li>";
        }
      }
    ?>
  </ul>
