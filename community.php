...
<nav class="bg-white shadow mb-6">
  ...
  <h2 class="text-2xl font-bold mb-4">Our Supporters</h2>
  <p>This project is supported by generous volunteers, NGOs, and kind-hearted educators who believe in equal opportunity for all students.</p>
</body>
</html>