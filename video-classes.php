...
<nav class="bg-white shadow mb-6">
  ...
  <h2 class="text-2xl font-bold mb-4">Recorded Classes</h2>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <iframe class="w-full h-64" src="https://www.youtube.com/embed/VIDEO_ID1" allowfullscreen></iframe>
    <iframe class="w-full h-64" src="https://www.youtube.com/embed/VIDEO_ID2" allowfullscreen></iframe>
  </div>
</body>
</html>